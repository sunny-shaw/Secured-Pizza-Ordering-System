...
<td height="65" colspan="5" bgcolor="">
    <b><center><font face="Verdana" color="white" size="18"><strong>Update Store Details</strong></font> </center></b>
</td>
</tr>
</tbody>
</table>
...
<form id="form1" name="form1" method="post" action="update_store_details.jsp">
  <center>
  <p>
    <label for="textfield"><strong>StoreId:</strong><br>
    </label>
    <input type="text" name="StoreId" required id="textfield">
</p>
  ...
  <p>
    <label for="textfield2"><strong>Pin-code:</strong><br>
    </label>
